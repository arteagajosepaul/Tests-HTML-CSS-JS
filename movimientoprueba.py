...
pygame.display.set_caption('Movimiento de Personaje con Animación')
...
while corriendo:
    ...
    pantalla.fill((255, 0, 0))  # Limpia la pantalla con color negro
    pantalla.blit(imagenes_personaje[indice_imagen], (pos_x, pos_y))  # Dibuja el personaje
